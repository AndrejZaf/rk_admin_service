...
public class SneakerController {
    ...
    @PostMapping
    public ResponseEntity<SneakerDTO> addSneaker(@RequestBody SneakerDTO sneakerDTO) {
        Sneaker sneaker = sneakerService.addSneaker(sneakerDTO);
        return new ResponseEntity<>(convertToSneakerDTO(sneaker), HttpStatus.OK);
    }

    @PutMapping
    public ResponseEntity<SneakerDTO> editSneaker(@RequestBody SneakerDTO sneakerDTO) {
